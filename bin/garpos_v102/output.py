...
def outresults(odir, suf, cfg, imp0, slvidx0,
    ...
    ashot = shots.loc[:,[
        'SET','LN','MT','TT','ResiTT', 'TakeOff', 'gamma', 'flag',
        'ST','ant_e0','ant_n0','ant_u0','sde0','sdn0','sdu0','head0','pitch0','roll0',
        'RT','ant_e1','ant_n1','ant_u1','sde1','sdn1','sdu1','head1','pitch1','roll1',
        'dV0', 'gradV1e', 'gradV1n', 'gradV2e', 'gradV2n',
        'dV', 'LogResidual', 
        ]]
    ...
    ashot['sde0'] = ashot['sde0'].round(5)
    ashot['sdn0'] = ashot['sdn0'].round(5)
    ashot['sdu0'] = ashot['sdu0'].round(5)
    ashot['sde1'] = ashot['sde1'].round(5)
    ashot['sdn1'] = ashot['sdn1'].round(5)
    ashot['sdu1'] = ashot['sdu1'].round(5)
